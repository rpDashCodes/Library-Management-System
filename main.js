...
async function fetchNumber(Schema){
Schema.countDocument();
}
...
app.get('/adDashboard', isAuthenticated, isAdmin, (req, res) => {
    res.sendFile(path.join(__dirName, "resource", "adminDashboard.html"));
})
